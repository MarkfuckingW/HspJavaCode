...
//            new Thread(shot).start();
    ...
    public void paint(Graphics g) {
        ...
        //画出hero射击的子弹
        if (hero.shot != null && hero.shot.isLive == true) { // 如果hero的子弹初始化，并且hero的子弹存活，画出hero的子弹
        ...
        switch (enemyTank.getDirect()) {
            ...
            case 2: //坦克向下
                if (s.x > enemyTank.getX() && s.x < enemyTank.getX() + 40
                        && s.y > enemyTank.getY() && s.y < enemyTank.getY() + 60) { // 如果子弹在坦克的范围内，表示击中tank
                    s.isLive = false;
                    enemyTank.isLive = false;  // 子弹和tank 销毁
